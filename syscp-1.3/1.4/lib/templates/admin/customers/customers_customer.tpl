     <tr>
      <td class="maintable"><a href="{$config->get('env.filename')}?s={$config->get('env.s')}&page={$config->get('env.page')}&action=su&id={$row['customerid']}" target="_blank">{$row['loginname']}</a></td>
      ...
      <td class="maintable"><a href="{$config->get('env.filename')}?s={$config->get('env.s')}&page={$config->get('env.page')}&action=delete&id={$row['customerid']}">{$lng['panel']['delete']}</a><br /><a href="{$config->get('env.filename')}?s={$config->get('env.s')}&page={$config->get('env.page')}&action=edit&id={$row['customerid']}">{$lng['panel']['edit']}</a></td>
     </tr>