$header
   <table cellpadding="3" cellspacing="1" border="0" align="center" class="maintable">
    ...
    <if $add><tr>
     <td colspan="20" class="maintable"><a href="{$config->get('env.filename')}?page={$config->get('env.page')}&action=add&s={$config->get('env.s')}">{$lng['admin']['templates']['template_add']}</a></td>
    </tr></if>
    <tr>
