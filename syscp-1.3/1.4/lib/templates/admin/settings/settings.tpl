$header
    <form method="post" action="{$config->get('env.filename')}">
     ...
     <table cellpadding="3" cellspacing="1" border="0" align="center" class="maintable">
      ...
      <tr>
       <td class="maintable" align="right"><b>{$lng['serversettings']['mysqlprefix']['title']}:</b><br />{$lng['serversettings']['mysqlprefix']['description']} ({$config->get('customer.accountprefix')}X{$config->get('customer.mysqlprefix')}Y)</td>
       <td class="maintable" nowrap><input type="text" name="customer_mysqlprefix" value="{$config->get('customer.mysqlprefix')}"></td>
      </tr>
      <tr>
       <td class="maintable" align="right"><b>{$lng['serversettings']['ftpprefix']['title']}:</b><br />{$lng['serversettings']['ftpprefix']['description']} ({$config->get('customer.accountprefix')}X{$config->get('customer.ftpprefix')}Y)</td>
      ...
      <tr>
       ...
       <td class="maintable" nowrap><input type="text" name="system_logfiles_directory" value="{$config->get('system.logfiles_directory')}"></td>
      </tr>
      <tr>
