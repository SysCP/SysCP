# $Id: syscp.sql 464 2006-04-23 17:54:24 +0200 (So, 23 Apr 2006) martin $
# --------------------------------------------------------
...
INSERT INTO `panel_settings` (`settingid`, `settinggroup`, `varname`, `value`) VALUES (13, 'system', 'apacheconf_directory', '/etc/apache2/sites-available/');
...
INSERT INTO `panel_settings` (`settingid`, `settinggroup`, `varname`, `value`) VALUES (22, 'panel', 'version', '1.3.0-dev1');
...
INSERT INTO `panel_settings` (`settingid`, `settinggroup`, `varname`, `value`) VALUES (31, 'system', 'apacheconf_filename', 'syscp-vhosts');
...
#
INSERT INTO `panel_tasks` (`file`, `class`, `method`, `params`) VALUES ('lib/classes/Org/Syscp/Core/Hooks/Traffic.class.php', 'Org_Syscp_Core_Hooks_Traffic', 'cronCalcTraffic', 'a%3A0%3A%7B%7D');
...
# 
# Table structure for table `panel_hooks`
# 

DROP TABLE IF EXISTS `panel_hooks`;
CREATE TABLE IF NOT EXISTS `panel_hooks` (
  `id` int(11) unsigned NOT NULL auto_increment,
...
# 
# Dumping data for table `panel_hooks`
# 

INSERT INTO `panel_hooks` (`id`, `priority`, `module`, `hook`, `file`, `class`, `method`) VALUES (1, 0, 'core', 'deleteCustomer', 'lib/classes/Org/Syscp/Core/Hooks/Apache.class.php', 'Org_Syscp_Core_Hooks_Apache', 'deleteCustomer');
INSERT INTO `panel_hooks` (`id`, `priority`, `module`, `hook`, `file`, `class`, `method`) VALUES (2, 0, 'core', 'deactivateCustomer', 'lib/classes/Org/Syscp/Core/Hooks/Apache.class.php', 'Org_Syscp_Core_Hooks_Apache', 'deactivateCustomer');
INSERT INTO `panel_hooks` (`id`, `priority`, `module`, `hook`, `file`, `class`, `method`) VALUES (3, 0, 'core', 'createDomain', 'lib/classes/Org/Syscp/Core/Hooks/Apache.class.php', 'Org_Syscp_Core_Hooks_Apache', 'createDomain');
INSERT INTO `panel_hooks` (`id`, `priority`, `module`, `hook`, `file`, `class`, `method`) VALUES (4, 0, 'core', 'deleteDomain', 'lib/classes/Org/Syscp/Core/Hooks/Apache.class.php', 'Org_Syscp_Core_Hooks_Apache', 'deleteDomain');
INSERT INTO `panel_hooks` (`id`, `priority`, `module`, `hook`, `file`, `class`, `method`) VALUES (5, 0, 'core', 'updateDomain', 'lib/classes/Org/Syscp/Core/Hooks/Apache.class.php', 'Org_Syscp_Core_Hooks_Apache', 'updateDomain');
INSERT INTO `panel_hooks` (`id`, `priority`, `module`, `hook`, `file`, `class`, `method`) VALUES (6, 0, 'core', 'deleteCustomer', 'lib/classes/Org/Syscp/Core/Hooks/Bind.class.php', 'Org_Syscp_Core_Hooks_Bind', 'deleteCustomer');
INSERT INTO `panel_hooks` (`id`, `priority`, `module`, `hook`, `file`, `class`, `method`) VALUES (7, 0, 'core', 'createDomain', 'lib/classes/Org/Syscp/Core/Hooks/Bind.class.php', 'Org_Syscp_Core_Hooks_Bind', 'createDomain');
INSERT INTO `panel_hooks` (`id`, `priority`, `module`, `hook`, `file`, `class`, `method`) VALUES (8, 0, 'core', 'deleteDomain', 'lib/classes/Org/Syscp/Core/Hooks/Bind.class.php', 'Org_Syscp_Core_Hooks_Bind', 'deleteDomain');
INSERT INTO `panel_hooks` (`id`, `priority`, `module`, `hook`, `file`, `class`, `method`) VALUES (9, 0, 'core', 'updateDomain', 'lib/classes/Org/Syscp/Core/Hooks/Bind.class.php', 'Org_Syscp_Core_Hooks_Bind', 'deleteDomain');
INSERT INTO `panel_hooks` (`id`, `priority`, `module`, `hook`, `file`, `class`, `method`) VALUES (10, 0, 'core', 'deleteIPPort', 'lib/classes/Org/Syscp/Core/Hooks/Bind.class.php', 'Org_Syscp_Core_Hooks_Bind', 'deleteIPPort');
INSERT INTO `panel_hooks` (`id`, `priority`, `module`, `hook`, `file`, `class`, `method`) VALUES (11, 0, 'core', 'createIPPort', 'lib/classes/Org/Syscp/Core/Hooks/Bind.class.php', 'Org_Syscp_Core_Hooks_Bind', 'createIPPort');
INSERT INTO `panel_hooks` (`id`, `priority`, `module`, `hook`, `file`, `class`, `method`) VALUES (12, 0, 'core', 'updateIPPort', 'lib/classes/Org/Syscp/Core/Hooks/Bind.class.php', 'Org_Syscp_Core_Hooks_Bind', 'updateIPPort');
INSERT INTO `panel_hooks` (`id`, `priority`, `module`, `hook`, `file`, `class`, `method`) VALUES (13, 0, 'core', 'createHTPasswd', 'lib/classes/Org/Syscp/Core/Hooks/Apache.class.php', 'Org_Syscp_Core_Hooks_Apache', 'createHTPasswd');
INSERT INTO `panel_hooks` (`id`, `priority`, `module`, `hook`, `file`, `class`, `method`) VALUES (14, 0, 'core', 'updateHTPasswd', 'lib/classes/Org/Syscp/Core/Hooks/Apache.class.php', 'Org_Syscp_Core_Hooks_Apache', 'updateHTPasswd');
INSERT INTO `panel_hooks` (`id`, `priority`, `module`, `hook`, `file`, `class`, `method`) VALUES (15, 0, 'core', 'deleteHTPasswd', 'lib/classes/Org/Syscp/Core/Hooks/Apache.class.php', 'Org_Syscp_Core_Hooks_Apache', 'deleteHTPasswd');
INSERT INTO `panel_hooks` (`id`, `priority`, `module`, `hook`, `file`, `class`, `method`) VALUES (16, 0, 'core', 'createHTAccess', 'lib/classes/Org/Syscp/Core/Hooks/Apache.class.php', 'Org_Syscp_Core_Hooks_Apache', 'createHTAccess');
INSERT INTO `panel_hooks` (`id`, `priority`, `module`, `hook`, `file`, `class`, `method`) VALUES (17, 0, 'core', 'updateHTAccess', 'lib/classes/Org/Syscp/Core/Hooks/Apache.class.php', 'Org_Syscp_Core_Hooks_Apache', 'updateHTAccess');
INSERT INTO `panel_hooks` (`id`, `priority`, `module`, `hook`, `file`, `class`, `method`) VALUES (18, 0, 'core', 'deleteHTAccess', 'lib/classes/Org/Syscp/Core/Hooks/Apache.class.php', 'Org_Syscp_Core_Hooks_Apache', 'deleteHTAccess');
INSERT INTO `panel_hooks` (`id`, `priority`, `module`, `hook`, `file`, `class`, `method`) VALUES (19, 0, 'core', 'createCustomer', 'lib/classes/Org/Syscp/Core/Hooks/Customer.class.php', 'Org_Syscp_Core_Hooks_Customer', 'createCustomer');
