<?php
			...
			if(isset($result['customerid']) && $result['customerid']==$this->User['customerid'])
			{
				if(isset($_POST['send']) && $_POST['send']=='send')
				{
					...
					if(isset($_POST['iswildcarddomain']) && $_POST['iswildcarddomain'] == '1' && $result['parentdomainid'] == '0' && $this->User['subdomains'] != '0')
					{
						...
						{
							$this->TemplateHandler->showError('firstdeleteallsubdomains');
							return false;
						}
						$iswildcarddomain = '1';
					}
...
//					$result['documentroot']=str_replace($this->User['documentroot'],'',$result['documentroot']);
					$iswildcarddomain = array( 1 => $this->L10nHandler->get('panel.yes'),
					...
					$pathSelect = makePathfield( $documentrootPrefix, $this->User['guid'],
