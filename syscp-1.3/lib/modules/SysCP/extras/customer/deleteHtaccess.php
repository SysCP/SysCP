<?php
		elseif($this->ConfigHandler->get('env.id')!=0)
		{
			...
			if(isset($result['customerid']) && $result['customerid']!='' && $result['customerid'] == $this->User['customerid'])
			{
				if (isset($_POST['send']) && $_POST['send']=='send')
				{
					...
					$this->HookHandler->call( 'OnDeleteHTAccess',
				...
				{
					$this->TemplateHandler->showQuestion('extras_reallydelete_pathoptions',
					                                     array('module' => 'extras',
