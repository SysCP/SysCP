...
$this->User = str_replace_array('-1', $this->L10nHandler->get('SysCP.globallang.unlimited'), $this->User, 'diskspace traffic mysqls emails email_accounts email_forwarders ftps subdomains');
