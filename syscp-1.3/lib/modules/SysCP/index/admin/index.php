...
$this->User = str_replace_array('-1', $this->L10nHandler->get('customer.unlimited'), $this->User, 'customers domains diskspace traffic mysqls emails email_accounts email_forwarders ftps subdomains');
...
{
	/**
			 * @todo check for an disabled string in the l10n files
			 */
