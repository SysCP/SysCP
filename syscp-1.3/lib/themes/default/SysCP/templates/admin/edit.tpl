		...
		<table cellpadding="5" cellspacing="4" border="0" align="center" class="maintable">
			<tr>
				<td colspan="2" class="maintitle">
					<img src="{$imagedir}title.gif" alt="" />&nbsp;{l10n get=SysCP.templates.template_edit}
				</td>
			</tr>
			<tr>
				<td class="main_field_name">{l10n get=SysCP.templates.language}:</td>
				<td class="main_field_display" nowrap="nowrap"><b>{$lang}</b></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="main_field_display" nowrap="nowrap">
					<input type="text" name="subject" value="{$subject}" maxlength="255" size="75" />
				</td>
			</tr>
			<tr>
				<td class="main_field_name">{l10n get=SysCP.templates.mailbody}: *</td>
				<td class="main_field_display" nowrap="nowrap">
					<textarea class="textarea_noborder" type="text" name="mailbody" rows="20" cols="75">{$mailbody}</textarea>
				</td>
			</tr>
			<tr>
