    <form method="post" action="{url module=templates action=add}">
     ...
     <table cellpadding="3" cellspacing="1" border="0" align="center" class="maintable">
      <tr>
       <td colspan="20" class="title">{l10n get=admin.templates.template_add}</td>
      </tr>
      <tr>
      ...
      <tr>
       <td class="maintable" colspan="2" align="right"><input type="hidden" name="prepare" value="prepare"><input type="submit" value="{l10n get=panel.next}"></td>
      </tr>
     </table>
    </form>
