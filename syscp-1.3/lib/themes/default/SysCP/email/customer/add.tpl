    <form method="post" action="{url module=email action=add}">
     <table cellpadding="3" cellspacing="1" border="0" align="center" class="maintable">
      <tr>
       <td colspan="2" class="title">{l10n get=emails.emails_add}</td>
      </tr>
      <tr>
      ...
      <tr>
       <td class="maintable">{l10n get=emails.iscatchall}</td>
       <td class="maintable" nowrap>
      ...
      <tr>
       ...
       <input type="submit" value="{l10n get=emails.emails_add}"></td>
      </tr>
     </table>
    </form>
