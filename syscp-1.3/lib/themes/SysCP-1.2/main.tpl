<html>
<head>
<link href="{$imagedir}main.css" rel="stylesheet" type="text/css">
<title>SysCP</title>
</head>
...
// -->
  ...
  <table border="0" width="100%" cellspacing="0" cellpadding="0">
    <tr>
      <td width="800"><img src="{$imagedir}header.gif" width="800" height="89"></td>
      <td background="{$imagedir}header_r.gif">&nbsp;</td>
    </tr>
  </table>
  <table border="0" width="100%" cellspacing="0" cellpadding="0" height="100%">
   <tr>
     <td width="240" valign="top" background="{$imagedir}background_l.gif">
     {foreach from=$navigation item=item}
       <br />
       <table border="0" width="200" cellspacing="0" cellpadding="0" align="center">
         <tr>
           <td background="{$imagedir}menu_h.gif" height="26" class="menu" align="center">
           {if $item.isLink}
           ...
           <td background="{$imagedir}menu_m.gif" class="menu">
           {foreach from=$item.childs item=subitem}
           	&nbsp;&nbsp;&nbsp;&raquo; <a href="{$subitem.url}" target="{$subitem.target}">{$subitem.lang}</a><br />
           {/foreach}
</td>
         </tr><tr>
           <td background="{$imagedir}menu_f.gif" height="11"></td>
         </tr>
       </table>
       {/foreach}

     </td>
     <td background="{$imagedir}background_m.gif" width="2">&nbsp;</td>
     <td background="{$imagedir}background_r.gif" class="maintable" valign="top"><br /><br />
