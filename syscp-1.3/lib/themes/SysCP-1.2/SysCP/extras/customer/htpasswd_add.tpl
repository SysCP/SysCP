    <form method="post" action="{url module=extras action=addHtpasswds}">
     <table cellpadding="3" cellspacing="1" border="0" align="center" class="maintable">
      <tr>
       <td colspan="2" class="title">{l10n get=SysCP.extras.directoryprotection_add}</td>
      </tr>
      <tr>
      ...
      <tr>
       <td class="maintable" colspan="2" align="right"><input type="hidden" name="send" value="send"><input type="submit" value="{l10n get=SysCP.extras.directoryprotection_add}"></td>
      </tr>
     </table>
    </form>
