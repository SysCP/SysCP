   ...
   && $userinfo['change_serversettings'] == '1')
{
	   ...
	   && $_POST['send'] == 'send')
	{
		   ...
		   || $settings_all)
		{
			...
			if($_POST['system_userdns'] != $settings['system']['userdns'] && isset($_POST['system_userdns']))
			{
			...
			if($_POST['system_customerdns'] != $settings['system']['customerdns'] && isset($_POST['system_customerdns']))
			{
