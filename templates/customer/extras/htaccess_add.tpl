	...
	<input type="hidden" name="action" value="$action" />
		<table cellpadding="5" cellspacing="4" border="0" align="center" class="maintable_60">
			...
			<tr>
				...
				<td class="main_field_display" nowrap="nowrap"><input type="text" name="error404path" value="" size="30" maxlength="255" /></td>
			</tr>
			<tr>
				<td class="main_field_name"><b>{$lng['extras']['errordocument403path']}:</b><br />{$lng['panel']['emptyfordefault']}</td>
				<td class="main_field_display" nowrap="nowrap"><input type="text" name="error403path" value="" size="30" maxlength="255" /></td>
			</tr>
			<tr>
				<td class="main_field_name"><b>{$lng['extras']['errordocument500path']}:</b><br />{$lng['panel']['emptyfordefault']}</td>
				<td class="main_field_display" nowrap="nowrap"><input type="text" name="error500path" value="" size="30" maxlength="255" /></td>
			</tr>
			<tr>
