<tr>
	<td class="field_name_border_left"><if $userinfo['userid'] == 1 && $row['adminid'] != 1><a href="$filename?s=$s&amp;page=$page&amp;action=su&amp;id={$row['adminid']}" target="_blank">{$row['loginname']}</a></if><if $userinfo['userid'] != 1 || $row['adminid'] == 1>{$row['loginname']}</if></td>
