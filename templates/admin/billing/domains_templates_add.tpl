$header
	<form method="post" action="$filename">
		...
		<table cellpadding="5" cellspacing="4" border="0" align="center" class="maintable_60">
			<tr>
				<td class="maintitle" colspan="2"><b><img src="images/title.gif" alt="" />&nbsp;{$lng['billing']['domains_templates_add']}</b></td>
			</tr>
			<tr>
				<td class="main_field_name">{$lng['domains']['topleveldomain']}:</td>
				<td class="main_field_display" nowrap="nowrap"><input type="text" name="tld" value="" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="main_field_display" nowrap="nowrap"><input type="text" name="valid_to" value="{$valid_to}" /></td>
			</tr>
			<tr>
