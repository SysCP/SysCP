$header
	<form method="post" action="$filename">
		...
		<table cellpadding="5" cellspacing="4" border="0" align="center" class="maintable_60">
			<tr>
				<td class="maintitle" colspan="2"><b><img src="images/title.gif" alt="" />&nbsp;{$lng['billing']['taxrate_edit']}</b></td>
			</tr>
			<tr>
				<td class="main_field_name">{$lng['billing']['taxrate']}:</td>
				<td class="main_field_display" nowrap="nowrap"><input type="text" name="taxrate_percent" value="{$result['taxrate_percent']}" size="18"/> %</td>
			</tr>
			<tr>
