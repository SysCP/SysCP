$header
	<form action="$filename" method="post">
		...
		<table cellpadding="5" cellspacing="4" border="0" align="center" class="maintable">
			<tr>
				<td class="maintitle_apply_left"><b><img src="images/title.gif" alt="" />&nbsp;{$lng['admin']['phpsettings']['editsettings']}</b></td>
			...
			<tr>
				...
				<td class="main_field_display"><input name="description" maxlength="40" size="60" type="text" value="{$row['description']}"/></td>
			</tr>
			<tr>
