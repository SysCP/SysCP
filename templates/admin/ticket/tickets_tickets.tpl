<tr>
  ...
  <td class="field_name">
    <a href="$filename?page=tickets&amp;action=archive&amp;id={$row['id']}&amp;s=$s">{$lng['ticket']['archive']}</a>
  </td>  
  <td class="field_name">
    <a href="$filename?page=tickets&amp;action=delete&amp;id={$row['id']}&amp;s=$s">{$lng['panel']['delete']}</a>
  </td>
</tr>