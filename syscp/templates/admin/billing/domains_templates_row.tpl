<tr>
	<td class="field_name_border_left">{$row['tld']}</td>
	...
	<td class="field_name"><a href="$filename?s=$s&amp;action=edit&amp;id={$row['id']}">{$lng['panel']['edit']}</a> <a href="$filename?s=$s&amp;action=delete&amp;id={$row['id']}">{$lng['panel']['delete']}</a></td>
</tr>
