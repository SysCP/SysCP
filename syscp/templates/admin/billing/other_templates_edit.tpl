$header
	<form method="post" action="$filename">
		...
		<table cellpadding="5" cellspacing="4" border="0" align="center" class="maintable_60">
			<tr>
				<td class="maintitle" colspan="2"><b><img src="images/title.gif" alt="" />&nbsp;{$lng['billing']['other_templates_edit']}</b></td>
			</tr>
			<tr>
				<td class="main_field_name">{$lng['billing']['caption_setup']}:</td>
				<td class="main_field_display" nowrap="nowrap">{$result['caption_setup']}</td>
			</tr>
			<tr>
				<td class="main_field_name">{$lng['billing']['caption_interval']}:</td>
				<td class="main_field_display" nowrap="nowrap">{$result['caption_interval']}</td>
			</tr>
			<tr>
