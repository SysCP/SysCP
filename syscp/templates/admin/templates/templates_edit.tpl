	...
	<input type="hidden" name="mailbodyid" value="$mailbodyid" />
		<table cellpadding="5" cellspacing="4" border="0" align="center" class="maintable">
			...
			<tr>
				...
				<td class="main_field_display" nowrap="nowrap"><input type="text" name="subject" value="$subject" maxlength="255" size="100" /></td>
			</tr>
			<tr>
				<td class="main_field_name" nowrap="nowrap">{$lng['admin']['templates']['mailbody']}: *</td>
				<td class="main_field_display" nowrap="nowrap"><textarea class="textarea_nobordo" name="mailbody" rows="20" cols="75">$mailbody</textarea></td>
			</tr>
			<tr>
