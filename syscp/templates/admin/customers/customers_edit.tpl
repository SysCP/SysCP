	...
	<form method="post" action="$filename">
		...
		<table cellpadding="5" cellspacing="4" border="0" align="center" class="maintable_60">
			...
			<tr>
				...
				<td class="main_field_display" nowrap="nowrap"><input type="text" class="textul" name="diskspace" value="{$result['diskspace']}" maxlength="6" /><select class="dropdown_noborder" name="discspace_type">$byte_type_option</select>&nbsp;{$diskspace_ul}</td>
			</tr>
			<tr>
				<td class="main_field_name">{$lng['customer']['traffic']}: *</td>
				<td class="main_field_display" nowrap="nowrap"><input type="text" class="textul" name="traffic" value="{$result['traffic']}" maxlength="3" /><select class="dropdown_noborder" name="traffic_type">$byte_type_option</select>&nbsp;{$traffic_ul}</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="main_field_display" nowrap="nowrap"><input type="text" class="textul" name="email_quota" value="{$result['email_quota']}" maxlength="9" />&nbsp;<select class="dropdown_noborder" name="email_quota_type">$byte_type_option</select>&nbsp;{$email_quota_ul}</td>
			</tr>
			</if>
			<tr>
