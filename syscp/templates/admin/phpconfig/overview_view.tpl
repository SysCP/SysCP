$header
	<table cellpadding="5" cellspacing="4" border="0" align="center" class="maintable">
		<tr>
			<td class="maintitle_apply_left"><b><img src="images/title.gif" alt="" />&nbsp;{$lng['admin']['phpsettings']['viewsettings']}</b></td>
		...
		<tr>
			...
			<td class="main_field_display"><strong>{$row['description']}</strong></td>
		</tr>
		<tr>
			<td class="main_field_name" valign="top">{$lng['admin']['phpsettings']['phpinisettings']}</td>
			<td class="main_field_display" valign="top"><textarea cols="80" rows="20">{$row['phpsettings']}</textarea></td>
		</tr>
		<tr>
