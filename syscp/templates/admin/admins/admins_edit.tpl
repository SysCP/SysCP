    ...
    <form method="post" action="$filename">
     ...
     <table cellpadding="3" cellspacing="1" border="0" align="center" class="maintable">
      ...
      <tr>
       ...
       <td class="maintable" nowrap><input type="text" name="customers" value="{$result['customers']}"></td>
      </tr>
      <tr>
      ...
      <tr>
       ...
       <td class="maintable" nowrap><input type="text" name="domains" value="{$result['domains']}"></td>
      </tr>
      <tr>
