		<table cellpadding="5" cellspacing="4" border="0" align="center" class="maintable">
			...
			<tr>
				...
				<td class="main_field_display" nowrap="nowrap"><input type="text" class="text" name="ticket_noreply_email" value="{$settings['ticket']['noreply_email']}" /></td>
			</tr>
			<tr>
				<td class="main_field_name"><b>{$lng['serversettings']['ticket']['noreply_name']}:</b></td>
				<td class="main_field_display" nowrap="nowrap"><input type="text" class="text" name="ticket_noreply_name" value="{$settings['ticket']['noreply_name']}" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="main_field_display" nowrap="nowrap"><input type="text" class="text" name="ticket_concurrently_open" value="{$settings['ticket']['concurrently_open']}" /></td>
			</tr>
			<tr>
				<td class="main_field_name"><b>{$lng['serversettings']['ticket']['archiving_days']}:</b></td>
				<td class="main_field_display" nowrap="nowrap"><input type="text" class="text" name="ticket_archiving_days" value="{$settings['ticket']['archiving_days']}" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="main_field_display" nowrap="nowrap"><input type="text" class="text" name="ticket_worktime_begin" value="{$settings['ticket']['worktime_begin']}" /></td>
			</tr>
			<tr>
				<td class="main_field_name"><b>{$lng['serversettings']['ticket']['worktime_end']}:</b><br />{$lng['serversettings']['ticket']['worktime_end_desc']}</td>
				<td class="main_field_display" nowrap="nowrap"><input type="text" class="text" name="ticket_worktime_end" value="{$settings['ticket']['worktime_end']}" /></td>
			</tr>
			<tr>
			...
			<tr>
				<td class="maintitle_apply_right" nowrap="nowrap" colspan="2">
					<input type="hidden" name="part" value="ticket" /><input class="bottom" type="reset" value="{$lng['panel']['reset']}" /><input class="bottom" type="submit" value="{$lng['panel']['save']}" />
				</td>
			</tr>
		</table>
