...
$lng['error']['errordocpathdupe'] = 'Op��o de caminho %s j&aacute; existe';
...
$lng['admin']['trafficlastrun'] = 'C&aacute;lculo do &Uacute;ltimo Tr&aacute;fego';
...
$lng['serversettings']['ticket']['noreply_email'] = 'N&atilde;o responder endere&ccedil;o de email';
$lng['serversettings']['ticket']['noreply_email_desc'] = 'O endere&ccedil;o de envio para tickets de suporte, normalmente &eacute; no-reply@domain.com';
$lng['serversettings']['ticket']['worktime_begin'] = 'Iniciado tempo de suporte (hh:mm)';
$lng['serversettings']['ticket']['worktime_begin_desc'] = 'In&iacute;cio quando o suporte estiver dispon&iacute;vel';
$lng['serversettings']['ticket']['worktime_end'] = 'Fim do tempo de suporte (hh:mm)';
$lng['serversettings']['ticket']['worktime_end_desc'] = 'Fim do tempo quando o suporte estiver dispon&iacute;vel';
...
$lng['serversettings']['ticket']['worktime_all'] = 'Sem tempo limite para suporte';
$lng['serversettings']['ticket']['worktime_all_desc'] = 'Se "Sim" para op&ccedil;&atilde;o para iniciar e finalizar vai ser substitu&iacute;da';
...
$lng['serversettings']['mod_fcgid']['configdir'] = 'Diret&oacute;rio de configura&ccedil;&atilde;o';
$lng['serversettings']['mod_fcgid']['configdir_desc'] = 'Aonde todos os arquivos de configura&ccedil;&atilde;o do fcgid v&atilde;o ser guardados? Se voc&ecirc; n&atilde;o utiliza um bin&aacute;rio compilado, est&aacute; &eacute; uma situa&ccedil;&atilde;o normal, deve estar dentro de /var/www/';
$lng['serversettings']['mod_fcgid']['tmpdir'] = 'Diret&oacute;rio Tempor&aacute;rio';
$lng['serversettings']['ticket']['reset_cycle'] = 'Resetar ciclo de tickers usados';
$lng['serversettings']['ticket']['reset_cycle_desc'] = 'Resetar tickets usados por clientes';
...
$lng['serversettings']['logger']['types'] = 'Tipos de Log(s)';
$lng['serversettings']['logger']['types_desc'] = 'Especificar tipos de logs separados por v&iacute;rgula.<br />Tipos de l&oacute;gs dispon&iacute;veis: syslog, file, mysql';
...
$lng['dkim']['dkim_domains']['description'] = '<em>Nome do Arquivo</em> dos Dom&iacute;nios do DKIM, parâmetro especificado na configura&ccedil;&atilde;o do dkim-Milter';
$lng['dkim']['dkim_dkimkeys']['title'] = 'Nome de arquivo de chaves';
$lng['dkim']['dkim_dkimkeys']['description'] = '<em>Nome do Arquivo</em>DKIM KeyList do parâmetro especificado na configura&ccedil;&atilde;o dkim-Milter';
...
$lng['serversettings']['awstats_domain_file']['title'] = 'Awstats diret&oacute;rio de arquivos do dominio';
...
$lng['serversettings']['allow_preset'] = 'Aceita reset de senha por clientes';
...
$lng['customer']['contract_number'] = 'Descri&ccedil;&atilde;o/N&uacute;mero de contrato';
$lng['customer']['additional_service_description'] = 'Descri&ccedil;&atilde;o adicional de servi&ccedil;o';
$lng['customer']['contract_details'] = 'Detalhes do contrato';
$lng['customer']['included_domains'] = 'Dom&iacute;nios Inclu&iacute;dos';
$lng['customer']['additional_traffic'] = 'Tr&aacute;fego Adicional';
...
$lng['customer']['payment_method'] = 'M&eacute;todo de Pagamento';
$lng['admin']['customer_categories_once'] = 'Incluir configura&ccedil;&otilde;es de taxas de clientes';
$lng['admin']['customer_categories_period'] = 'Incluir intervalo de tavas de clientes';
$lng['customer']['bankaccount_holder'] = 'Propriet&aacute;rio da conta';
$lng['customer']['bankaccount_number'] = 'N&uacute;mero da conta';
$lng['customer']['bankaccount_blz'] = 'N&uacute;mero da ag&ecirc;ncia';
...
$lng['service']['interval_payment_prepaid'] = 'Pr&eacute; Pago';
$lng['service']['interval_payment_postpaid'] = 'P&oacute;s Pago';
...
$lng['serversettings']['allow_preset_desc'] = 'Os clientes podem redefinir sua senha e  ser&atilde;o enviadas para seu endere&ccedil;o de e-mail';
$lng['serversettings']['allow_preset_admin'] = 'Ativa reset de senhas pelos administradores';
$lng['serversettings']['allow_preset_admin_desc'] = 'Admins / Revendedor pode redefinir sua senha e a nova senha ser&aacute; enviada para seu endere&ccedil;o de e-mail';
...
$lng['admin']['syscp_graphic']['title'] = 'Cabe&ccedil;alho gr&aacute;fico do SyCP';
$lng['admin']['syscp_graphic']['description'] = 'Quais gr&aacute;ficos devem aparece no topor';
...
$lng['serversettings']['mod_fcgid']['starter'] = 'Processos por dom&iacute;nio';
$lng['serversettings']['mod_fcgid']['starter_desc'] = 'Quantos processos devem ser iniciadas / permitidas por dom&iacute;nio? O valor 0 &eacute; recomendado. O PHP ir&aacute; ent&atilde;o gerir a quantidade de processos.';
$lng['serversettings']['mod_fcgid']['wrapper'] = 'Wrapper in Vhosts';
$lng['serversettings']['mod_fcgid']['wrapper_desc'] = 'Como os  wrapper v&atilde;o ser inclu&iacute;dos nos vhosts';
$lng['serversettings']['mod_fcgid']['tmpdir_desc'] = 'Aonde os arquivos tempor&aacute;rios devem ser guardados';
$lng['serversettings']['mod_fcgid']['peardir'] = 'Diret&oacute;rios globais do PEAR';
$lng['serversettings']['mod_fcgid']['peardir_desc'] = 'Diret&oacute;rios globais do PEAR que dever&atilde;o ser substitu&iacute;dos em cada configura&ccedil;&atilde;o php.ini? Diferentes diret&oacute;rios devem ser separados por dois pontos.';
...
$lng['serversettings']['index_file_extension']['title'] = 'Extens&atilde;o do arquivo rec&eacute;m-criado no Índice do diret&oacute;rio do cliente.';
...
$lng['aps']['noinstancesexisting'] = 'N&atilde;o existem estâncias para administrar.';
...
$lng['serversettings']['mod_fcgid']['maxrequests'] = 'M&aacute;ximo de solicita&ccedil;&otilde;es por Dom&iacute;nio';
$lng['serversettings']['mod_fcgid']['maxrequests_desc'] = 'Quantas solicita&ccedil;&otilde;es ser&atilde;o aceitas por dom&iacute;nio?';
