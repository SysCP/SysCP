...
$lng['serversettings']['ticket']['noreply_email'] = 'Bez odpovìdní e-mailová adresa';
$lng['serversettings']['ticket']['noreply_email_desc'] = 'Odesílatelova adresa pro tikety podpory, vìtšinou nìco jako no-reply@domain.tld';
$lng['serversettings']['ticket']['worktime_begin'] = 'Zaèátek práce podpory (hh:mm)';
$lng['serversettings']['ticket']['worktime_begin_desc'] = 'Start-time pokud je podpora k dispozici';
$lng['serversettings']['ticket']['worktime_end'] = 'Konec práce podpory (hh:mm)';
...
$lng['serversettings']['ticket']['worktime_all'] = 'Podpora bez èasového omezení';
$lng['serversettings']['ticket']['worktime_all_desc'] = 'Pokud "Ano" monosti zaèátku a konce práce podpory bude pøepsána';
