 ...
 */
	...
	if($settings['panel']['version'] == '1.2.6')
	{
		...
		$db->query('INSERT INTO `'.TABLE_PANEL_TEMPLATES.'` (id, adminid, language, templategroup, varname, value) VALUES (2, 1, \'English\', \'mails\', \'createcustomer_mailbody\', \'Hello {SURNAME} {NAME},\r\n\r\nhere is your account information:\r\nUsername: {USERNAME}\r\nPassword: {PASSWORD}\r\n\r\nThank you,\r\nthe SysCP-Team\')');
		...
		$db->query('INSERT INTO `'.TABLE_PANEL_TEMPLATES.'` (id, adminid, language, templategroup, varname, value) VALUES (6, 1, \'Deutsch\', \'mails\', \'createcustomer_mailbody\', \'Hallo {SURNAME} {NAME},\r\n\r\nhier ihre Accountinformationen:\r\n\r\nBenutzername: {USERNAME}\r\nPassword: {PASSWORD}\r\n\r\nVielen Dank,\r\nIhr SysCP-Team\')');
		...
		$db->query('INSERT INTO `'.TABLE_PANEL_TEMPLATES.'` (id, adminid, language, templategroup, varname, value) VALUES (10, 1, \'Francais\', \'mails\', \'createcustomer_mailbody\', \'Bonjour {SURNAME} {NAME},\r\n\r\nici vos informations d´acc&egrave;s:\r\n\r\nIdentifiant: {USERNAME}\r\nMot de passe: {PASSWORD}\r\n\r\nNous vous remercions,\r\nVotre Webmaster\')');
		...
		$db->query('INSERT INTO `'.TABLE_PANEL_TEMPLATES.'` (id, adminid, language, templategroup, varname, value) VALUES (14, 1, \'Chinese\', \'mails\', \'createcustomer_mailbody\', \'&#24744;&#22909;{SURNAME} {NAME},\n\n&#36825;&#37324;&#26159;&#24744;&#30340;&#36134;&#25143;&#20449;&#24687;:\n\n&#29992;&#25143;&#21517;: {USERNAME}\n&#23494;&#30721;: {PASSWORD}\n\n&#38750;&#24120;&#24863;&#35874;&#65292;&#24744;&#30340;&#26381;&#21153;&#23567;&#32452;\')');
	...
	if($settings['panel']['version'] == '1.2.6-cvs1')
	{
		$db->query(
			...
			'WHERE `parent_url`=\'admin_index.php\''
		);
