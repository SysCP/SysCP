...
$lng['admin']['syscpdetails'] = 'Informations de SysCP';
...
$lng['admin']['configfiles']['mail'] = 'Serveur de Mails (POP3 / IMAP)';
...
$lng['panel']['intervalfee_type']['y'] = 'Années';
$lng['panel']['intervalfee_type']['m'] = 'Mois';
$lng['panel']['intervalfee_type']['d'] = 'Jours';
$lng['panel']['intervalfee_type_one']['y'] = 'Année';
...
$lng['admin']['customer_categories_period'] = 'Inclure des frais périodiques aux clients';
$lng['customer']['taxid'] = 'Numéro d\'identification de la taxe';
$lng['customer']['calc_tax'] = 'Calculer le montant des taxes';
$lng['customer']['create_contract'] = 'Créer le contrat';
$lng['customer']['contract_date'] = 'Date du contrat';
$lng['customer']['contract_number'] = 'Description / Numéro du contrat';
$lng['customer']['additional_service_description'] = 'Description additionnelle pour le service';
$lng['customer']['contract_details'] = 'Détails du contrat';
...
$lng['customer']['term_of_payment'] = 'Délai de paiement';
...
$lng['customer']['payment_methods'][CONST_BILLING_PAYMENTMETHOD_DEBITCARD] = 'Carte de crédit';
$lng['customer']['bankaccount_holder'] = 'Titulaire du compte';
$lng['customer']['bankaccount_number'] = 'Numéro de compte';
$lng['customer']['bankaccount_blz'] = 'Numéro de la banque';
$lng['customer']['bankaccount_bank'] = 'Nom de la banque';
$lng['service']['quantity'] = 'Quantité';
...
$lng['service']['interval_payment_prepaid'] = 'Prépayé / avant paiement';
$lng['service']['interval_payment_postpaid'] = 'Post payé / après paiement';
$lng['service']['setup_fee'] = 'Montant des frais d\'installation';
$lng['service']['active'] = 'Service activé';
$lng['service']['start_date'] = 'Activé depuis';
$lng['service']['end_date'] = 'Inactif depuis';
$lng['service']['lastinvoiced_date'] = 'Dernière facture';
...
$lng['invoice']['preview'] = 'Pré-visualiser';
$lng['invoice']['dateheader'] = 'Fait à %s';
$lng['invoice']['number'] = 'Facture numéro';
$lng['invoice']['contract_number'] = 'Numéro de contrat';
$lng['invoice']['contract_details'] = 'Détails du contrat';
$lng['invoice']['contract_details_template'] = 'Contrat d\'hébergement Web %s contenant un espace de %s Mo, ' . chr(128) . 'pour un prix de %s par Go supplémentaires, %s Go de trafic, ' . chr(128) . 'pour un prix de %s par Go supplémentaire; inclus les noms de domaines de %s tous les %s %s';
$lng['invoice']['period'] = 'Période de facturation';
...
$lng['invoice']['credit_note'] = 'Note de crédit';
$lng['invoice']['total'] = 'Total';
$lng['invoice']['payment_methods'][0] = 'Le montant de la facture à payer dans un délai de %s jours. ' . "\n" . 'N\'ayant pas encore reçu de règlement à ce jour, nous vous prions de vouloir effectuer votre règlement par virement bancaire sur notre compte à créditer. Si vous souhaitez opter pour le prélèvement automatique, veuillez remplir le formulaire et nous le renvoyer par courrier postal.';
$lng['invoice']['payment_methods'][1] = 'Le montant de la facture est de %s à notre crédit dans un délai de %s, sur notre compte numéro %s, %s recouvrées par prélèvement';
$lng['invoice']['tax_text']['line'] = 'T.V.A. %s : %s' . "\n";
$lng['invoice']['tax_text']['client'] = 'du client';
$lng['invoice']['state'] = 'état';
$lng['invoice']['states'][CONST_BILLING_INVOICESTATE_INVOICED] = 'facturé';
$lng['invoice']['states'][CONST_BILLING_INVOICESTATE_SENT] = 'envoyé';
$lng['invoice']['states'][CONST_BILLING_INVOICESTATE_PAID] = 'payé';
$lng['invoice']['states'][CONST_BILLING_INVOICESTATE_CANCELLED_NO_REINVOICE] = 'annulé (par de refacturation)';
$lng['invoice']['states'][CONST_BILLING_INVOICESTATE_CANCELLED_REINVOICE_WITHOUT_CREDIT_NOTE] = 'annulé (refacturation sans note de crédit)';
$lng['invoice']['states'][CONST_BILLING_INVOICESTATE_CANCELLED_REINVOICE_WITH_CREDIT_NOTE] = 'annulé (refacturation avec note de crédit)';
$lng['invoice']['states'][CONST_BILLING_INVOICESTATE_CANCELLED_REINVOICED] = 'annulé (re-facturé)';
$lng['invoice']['state_change'] = 'dernier changement d\'état';
$lng['invoice']['change_state'] = 'changer l\'état de la facture';
$lng['invoice']['total_fee'] = 'sans taxe';
$lng['invoice']['total_fee_taxed'] = 'Total';
$lng['invoice']['fix'] = 'Correction de la facture';
$lng['invoice']['pdf'] = 'Créer un PDF';
$lng['invoice']['create_reminder'] = 'Créer un rappel';
$lng['invoice']['changelog'] = 'Historique des changements';
$lng['invoice']['deleted_line'] = 'La ligne a été supprimée.';
...
$lng['billing']['cacheinvoicefees'] = 'Mettre à jour la liste / les tarifs';
$lng['billing']['invoice'] = 'Facture';
$lng['billing']['invoice_date'] = 'Date de facture';
$lng['billing']['invoice_fee'] = 'Frais de facture';
$lng['billing']['preview'] = 'Pré-visualiser';
$lng['billing']['caption'] = 'Légende';
$lng['billing']['number'] = 'Facture numéro';
$lng['billing']['caption_setup'] = 'Légende pour les frais d\'installation';
$lng['billing']['caption_interval'] = 'Légende pour les frais de gestion interne';
$lng['billing']['template'] = 'Modèle';
...
$lng['billing']['domains_templates'] = 'Modèle de domaine';
$lng['billing']['domains_templates_add'] = 'Ajouter un modèle de domaine';
$lng['billing']['domains_templates_edit'] = 'Modifier un modèle de domaine';
$lng['billing']['other_templates'] = 'Autres modèles de services';
$lng['billing']['other_templates_add'] = 'Ajouter d\'autres modèles de services';
$lng['billing']['other_templates_edit'] = 'Modifier les autres modèles de services';
$lng['billing']['categories']['hosting_caption'] = 'Hébergement';
$lng['billing']['categories']['hosting_rowcaption_setup'] = 'Contrat d\'hébergement - Frais d\'installation';
$lng['billing']['categories']['hosting_rowcaption_interval'] = 'Contrat d\'hébergement';
$lng['billing']['categories']['hosting_rowcaption_setup_withloginname'] = 'Contrat d\'hébergement ({loginname}) - Frais d\'installation';
$lng['billing']['categories']['hosting_rowcaption_interval_withloginname'] = 'Contrat d\'hébergement  ({loginname})';
...
$lng['billing']['categories']['traffic_rowcaption_setup'] = $lng['billing']['categories']['traffic_rowcaption_interval'] = 'Trafic utilisé : {traffic_total}/{traffic_included} Go';
$lng['billing']['categories']['traffic_rowcaption_setup_unlimited'] = $lng['billing']['categories']['traffic_rowcaption_interval_unlimited'] = 'Trafic utilisé : {traffic_total}/' . $lng['customer']['unlimited'] . ' Go';
...
$lng['billing']['categories']['diskspace_rowcaption_setup'] = $lng['billing']['categories']['diskspace_rowcaption_interval'] = 'Espace Web utilisé : {diskspace_total}/{diskspace_included} Go';
$lng['billing']['categories']['diskspace_rowcaption_setup_unlimited'] = $lng['billing']['categories']['diskspace_rowcaption_interval_unlimited'] = 'Espace Web utilisé : {diskspace_total}/' . $lng['customer']['unlimited'] . ' Go';
$lng['question']['billing_invoice_row_reallydelete'] = 'Etes-vous sûr de vouloir supprimer cette ligne de facturation ?';
$lng['question']['billing_invoice_row_reallyreset'] = 'Etes-vous sûr de vouloir ignorer tous les changements effectués à cette facture ?';
$lng['question']['billing_invoice_row_reallyreset_key'] = 'Etes-vous sûr de vouloir ignorer tous les changements effectués à cette ligne ?';
$lng['question']['billing_domains_template_reallydelete'] = 'Etes-vous sûr de vouloir supprimer le modèle pour "%s" ?';
$lng['question']['billing_other_template_reallydelete'] = 'Etes-vous sûr de vouloir supprimer le modèle pour "%s" ?';
$lng['question']['billing_other_service_reallydelete'] = 'Etes-vous sûr de vouloir supprimer ce service ?';
$lng['question']['billing_taxrate_reallydelete'] = 'Etes-vous sûr de vouloir supprimer ce taux de taxe ?';
...
$lng['admin']['billingsettings'] = 'Paramètres de facturation';
$lng['serversettings']['billing']['activate_billing']['title'] = 'Activer la facturation';
$lng['serversettings']['billing']['activate_billing']['description'] = 'Ici, vous pouvez activer / désactiver le système global de facturation.';
$lng['serversettings']['billing']['highlight_inactive']['title'] = 'Mettre en surbrillance les factures impayées';
$lng['serversettings']['billing']['highlight_inactive']['description'] = 'Est-ce les factures impayées doivent être mises en surbrillance ?';
$lng['serversettings']['billing']['invoicenumber_count']['title'] = 'Numéro de facture actuel';
$lng['serversettings']['billing']['invoicenumber_count']['description'] = 'Est un numéro de facture fixe. Lors de tous changements, vous serez amené à en discuter avec votre comptable.';
