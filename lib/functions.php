...
function createAWStatsConf($logFile, $siteDomain, $hostAliases)
{
    ...
    $header2 = "## Do not remove the line above! This tells SysCP to update this configuration\n" . "## If you wish to manually change this configuration file, remove the first line to make sure SysCP won't rebuild this file" . "## Generated for domain {SITE_DOMAIN} on " . date('l dS \of F Y h:i:s A') . "\n";
    ...
    fwrite($awstats_domain_conf, $header2);
